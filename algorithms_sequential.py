...
def extract_keypoints_sequential(queue1, queue2, args1 , args2, consecutive_frames=DEFAULT_CONSEC_FRAMES):
    ...
    while time.time() - t0 < max_time:
        ...
        result1 = process_vidframe(queue1,args1,cam1,tagged_df1,processor_singleton1,width1,height1,frame,t0,output_video1)
        result2 = process_vidframe(queue2,args2,cam2,tagged_df2,processor_singleton2,width2,height2,frame,t0,output_video2)
